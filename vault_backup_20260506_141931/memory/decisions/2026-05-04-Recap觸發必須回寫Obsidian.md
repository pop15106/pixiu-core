...
選擇: "使用者主動輸入 recap/摘要/現在到哪了/下一步/進度 時，當前 recap 必須立即寫入 vault/memory/recaps"
棄選方案: "Quick Recap 只輸出、不寫檔"
原因: "避免長任務的關鍵狀態只留在對話中，確保下次 session 與 Obsidian Dashboard 可接續"
