...
> ⚠️ **時效警語（2026-07-03 稽核）**：本索引最後實質更新為 2026-03-18，數量統計與 `AGENTS.md`、根目錄 `README.md`（2026-05-27 盤點：頂層 skills 68＋ECC skills 148、commands 58、rules 51）互相不一致。**本檔僅供分類參考；數量與清單以根目錄 README 最新盤點為準。** AI 不得引用本檔數字做決策；「Gemini 知識型 skills 已嵌入 GEMINI.md」之描述已失效。
>
> 176+ skills · 76 slash commands · 50 rules（2026-03-18 舊值，見上方警語）
