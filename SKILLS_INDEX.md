...
## 目前盤點（基準 2026-07-27；Skill 數量於 2026-09-21 更新）

| 類型 | 數量 | 說明 |
|---|---:|---|
| Canonical Skill 文件 | 96 | `skills/` 下 95 個 `SKILL.md`，加上 `skills/INDEX.md` 路由索引 |
| Portable Skill 發佈目錄 | 93 | `.agents/skills/`；供 OpenAI／Codex 可攜發佈，不是 canonical 真源 |
...
除 Skill 數量已於 2026-09-21 重新盤點外，其餘數量仍代表 2026-07-27 的 repository 快照。新增、刪除或搬移能力後，先執行 README 的「快速盤點指令」與 Lazy Loading 驗證，再更新本表。
