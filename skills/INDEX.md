...
| Skill | 什麼情境用 |
|---|---|
| `work-document-orchestrator` | 自然語言工作文件總控：不需固定口令，從需求、SA/PM 交辦、追加異動、報修、資料修復、事故、上版、操作手冊、資安排除等語意建立 Work Record，保存原始交辦與 PG 理解、Scope、證據、決策與覆核，再路由既有專門 Skill，持續更新至 Final。 |
