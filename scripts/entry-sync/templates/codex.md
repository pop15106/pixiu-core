# PixiuCore Codex Global Entry

<!-- PIXIU-GLOBAL-ENTRY:1 tool=codex -->
...
3. 使用 Git fallback 時先讀 `<core>\vault\bootstrap\GIT-FALLBACK-BOOTSTRAP.md`；接著讀 `<core>\CODEX.md` 與 `<core>\.codex\AGENTS.md`，再載入 `<core>\vault\bootstrap\SESSION-BOOTSTRAP.md`。
