...
system: PIXIUCORE
repo: pixiu-core
topic: mothership-bidirectional-sync-obsidian-dashboard
status: done
tags: [recap, session, pixiucore, sync, obsidian]
summary: 完成 PixiuCore 母體雙向同步與 Obsidian Dashboard 基線建立，並記錄 cp 巢狀路徑與 /recap 觸發限制。
---
