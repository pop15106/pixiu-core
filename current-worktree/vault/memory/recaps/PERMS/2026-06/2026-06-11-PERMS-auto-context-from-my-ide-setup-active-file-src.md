...
system: PERMS
repo: auto-detected
topic: auto-context-from-my-ide-setup-active-file-src
status: draft-auto
recap_mode: auto
auto_trigger: session-end
auto_transcript_hash: 7ecf169b2549e3b5
tags: [recap, auto, draft-auto, perms]
source_paths:
  - transcript
summary: "# Context from my IDE setup: ## Active file: src/main/resources/mapper/BatchLogMapper.xml ## Active selection of the file: <select id=\"queryTop10\" parameterType=\"HashMap\" resultTyp"
---

# Auto Recap: context-from-my-ide-setup-active-file-src
...
- mode: auto
- trigger: session-end
- transcript: C:\Users\7010\Desktop\gravityTest\pixiu-core\vault\memory\hook-state\codex-thread-watcher\transcripts\019eb4d8-d599-7b92-974c-2f0e88b3e7b5-45abb9e13aac.jsonl
- hash: 45abb9e13aac19f2
