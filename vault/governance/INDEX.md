...
| 本機母體／DevSpace 不可用，使用者明確要求切 Git／Git fallback | `../bootstrap/GIT-FALLBACK-BOOTSTRAP.md` |
...
| `../bootstrap/GIT-FALLBACK-BOOTSTRAP.md` | Git fallback 母體載入、獨立 checkout 與 Router 銜接 | 低 |
